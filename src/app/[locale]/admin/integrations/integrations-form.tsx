...
const SERVICES: ServiceConfig[] = [
  ...
  },
  {
    ...
    description:
      'Sign up at orcid.org/developer-tools → Register app → Redirect URI: https://repo.algonest.tech/api/auth/orcid/callback',
    descriptionAr:
      'سجّل في orcid.org/developer-tools → أنشئ تطبيق → Redirect URI: https://repo.algonest.tech/api/auth/orcid/callback',
  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        placeholder: 'mailto:admin@algonest.tech',
      },
    ],
  },
  {
    ...
    fields: [
      {
        ...
        placeholder: 'admin@algonest.tech',
      },
    ],
  },
  {
