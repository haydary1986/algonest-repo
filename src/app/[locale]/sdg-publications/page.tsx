...
async function fetchSdgWorks(page: number) {
  const res = await fetch(
    `https://api.openalex.org/works?filter=institutions.id:${OPENALEX_INSTITUTION_ID},sustainable_development_goals.score:%3E0.3,is_retracted:false&per_page=20&page=${page}&sort=cited_by_count:desc&select=title,publication_year,doi,cited_by_count,sustainable_development_goals,authorships,primary_location,open_access`,
