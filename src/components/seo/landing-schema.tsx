...
export function LandingSchema() {
  ...
  const webSite = {
    ...
    '@id': `${url}/#website`,
    url,
    name: 'Algonest Researcher Directory',
  ...
  const softwareApplication = {
    ...
    '@id': `${url}/#app`,
    name: 'RIS — Algonest Researcher Information System',
    applicationCategory: 'EducationalApplication',
    operatingSystem: 'Web',
    url,
    description:
      'A researcher directory and academic profile platform for Algonest. Every faculty member gets a public, citable academic profile with publications, citations, and a one-click CV. Bilingual (Arabic / English).',
    featureList: [
  ...
  const faqPage = {
    ...
    mainEntity: [
      {
        '@type': 'Question',
        name: 'What is the Algonest Researcher Directory?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'It is the official directory of researchers at Algonest, Iraq. Each researcher has a public academic profile with their biography, research interests, publications, citations, and affiliations — searchable by college, department, research area, or SDG.',
        },
      },
      {
        '@type': 'Question',
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Yes. Every faculty member has a dedicated public profile at repo.algonest.tech/{locale}/researcher/{username}. The profile serves as their citable academic identity, indexed by Google with Person and ProfilePage structured data.',
        },
      },
      {
        '@type': 'Question',
